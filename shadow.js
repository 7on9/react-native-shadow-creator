 ...
 * @param {Number} depth depth of object [1-24]
 * @param {String} color color of object (hex value) - default '#000'
 */
export const shadow = (depth, color) => {
    ...
    return {
        ...
        shadowRadius: parseFloat(interpolate(s.blur, 1, 38, 1, 16).toFixed(2)), //(s.blur * 0.45).toFixed(2),
        elevation: depth,
    }
}
